...
namespace Watcher
{
    public class MonitoringModel
    {
        ...
        //        #region CPU
        //        double currentCPULoad = _loader.GetCPULoad();
        ...
        //        #region RAM
        //        double currentRAMLoad = _loader.GetRAMLoad();
        ...
        //        #region Disk
        //        double currentDiskLoad = _loader.GetDiskLoad();
        //        if (LoadDisk < currentDiskLoad)
        //            timeLimits[2]++;
        //        else
        //            timeLimits[2] = 0;

        //        if (timeLimits[2] > TimeLimitDisk)
        //        {
        ...
        //        #region Network
        //        long currentNetworkLoad = _loader.GetNetworkLoad();
